        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              // Input NIM
              TextFormField(
                autofocus: true,//fungsi fokus saat user menekan textfromfield
                decoration: const InputDecoration(
                  hintText: 'Nim',
                  labelText: 'Nim',
                  icon: Icon(Icons.person_pin), // Tambahan ikon 
                  border: OutlineInputBorder(), // Tambahan border
                ),
              ...
              TextFormField(
                decoration: const InputDecoration(
                  hintText: 'Nama',
                  labelText: 'Nama',
                  icon: Icon(Icons.person), // Tambahan ikon
                  border: OutlineInputBorder(), // Tambahan border
                ),
                keyboardType: TextInputType.text,
                validator: (String? value) {
              ...
              TextFormField(
                decoration: const InputDecoration(
                  ...
                  icon: Icon(Icons.dashboard), // Tambahan ikon
                  border: OutlineInputBorder(), // Tambahan border
                ),
                keyboardType: TextInputType.text,
                validator: (String? value) {
              ...
              TextFormField(
                decoration: const InputDecoration(
                  hintText: 'Semester',
                  labelText: 'Semester',
                  icon: Icon(Icons.format_list_numbered), // Tambahan ikon
                  border: OutlineInputBorder(), // Tambahan border
                ),
